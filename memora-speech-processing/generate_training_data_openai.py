...
Uses OpenAI API (GPT-4o-mini) to create high-quality training examples
Cost: ~$0.30 for 100 examples (much cheaper than Claude)
"""
...
class TrainingDataGenerator:
    ...
    def create_example_transcriptions(self):
        ...
        # These are example scenarios - GPT will create variations
        scenarios = [
            {
    ...
    def generate_memory_summary(self, transcription, keywords):
        """Use OpenAI to generate a perfect memory summary"""
...
Return ONLY valid JSON, no other text."""
        ...
        try:
            response = self.client.chat.completions.create(
                ...
                messages=[
                    {"role": "system", "content": "You are a helpful assistant that creates memory summaries in JSON format. Always return valid JSON only."},
...
Create a memory summary with title, quick_summary, key_points, action_items, people, and tags."""
    ...
    def generate_dataset(self, num_examples=100, output_file="training_data.jsonl"):
        ...
        print(f"\nGenerating {num_examples} training examples using OpenAI GPT-4o-mini...")
...
def main():
    """Main function"""
    print("="*60)
    print("Training Data Generator for Llama 3.2 3B (OpenAI)")
    print("="*60)
    ...
    print("Note: Each example costs ~$0.003 with GPT-4o-mini")
    ...
    estimated_cost = num_examples * 0.003
